...
import 'package:kingof2odds/app/sign_up_with_email/sign_up_with_email_screen.dart';
    ...
    return Scaffold(
      body: SafeArea(
        ...
        children: <Widget>[
          GestureDetector(
              onTap: (){
                        Navigator.push(context,CupertinoPageRoute(builder: (BuildContext context) => SignUpWithEmailLogIn()));
              },
              child: signUpBtn(
        ...
        height: 170,
                  ...
                  GestureDetector(
        onTap: () {
            Navigator.push(context,CupertinoPageRoute(builder: (BuildContext context) => ResigrationScreen()));
        },
        child: Container(
          child: Text(
