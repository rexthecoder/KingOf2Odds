...
import 'package:kingof2odds/app/sign_in/sign_in_view_model.dart';
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(
                      ...
                      'assets/images/sport-${widget.color}.png', fit: BoxFit.contain),
                  ),
                ),
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: MaterialButton(
            ...
            onPressed: () {
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => ResigrationScreen()));
            },
          ),
        )
      ],
